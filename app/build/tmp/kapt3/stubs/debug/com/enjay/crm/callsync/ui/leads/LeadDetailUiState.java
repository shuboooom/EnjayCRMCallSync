...
public final class LeadDetailUiState {
    ...
    private final java.util.List<com.enjay.crm.callsync.data.local.LeadCallLogEntity> callLogs = null;
    ...
    java.util.List<com.enjay.crm.callsync.data.local.LeadCallLogEntity> callLogs) {
        super();
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.enjay.crm.callsync.data.local.LeadCallLogEntity> getCallLogs() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.enjay.crm.callsync.data.local.LeadCallLogEntity> component4() {
        return null;
    }
